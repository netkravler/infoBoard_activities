export const formatDate = (d, val) => {
  ...
  /** Gives the hour according to the timestamp */
  let Hours = createPrefix(date.getHours());

  /** Gives the minute according to the timestamp */
  let minute = createPrefix(date.getMinutes());

  /** Gives the seconds according to the timestamp */
